...
<div class="category-module home-features <?php echo $moduleclass_sfx; ?>">
<div class="row">
	<?php 
	//Get category info
	if(isset($jacategory)) : ?>
	<div class="category-info col-sm-4">
		<div class="item-inner text-left">
			...
			<a class="btn btn-primary" href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($jacategory->id));?>"><?php echo JText::_('VIEW_ALL'); ?></a>
		</div>
	</div>
	<?php endif;
	//End add
	...
	<div class="col-sm-8 category-module-inner">
	<div class="row">
	<?php 
		$numberColumn = $params->get('article_column',2);
		$count = 1;
	?>
			...
			?>
				<div class="img-intro">
					<a href="<?php echo $item->link; ?>"><img
						...
						src="<?php echo htmlspecialchars($images->image_intro); ?>" alt="<?php echo htmlspecialchars($images->image_intro_alt); ?>" class="img-responsive"/></a>
				</div>
			<?php } ?>
		</div>
