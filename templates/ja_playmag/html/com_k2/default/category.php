...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemListCategoriesBlock">
		...
		<div class="itemListCategory">
			...
			<span class="catItemAddLink">
				<a class="modal k2-btn" rel="{handler:'iframe',size:{x:990,y:650}}" href="<?php echo $this->addLink; ?>">
					<i class="fa fa-plus"></i> <?php echo JText::_('K2_ADD_A_NEW_ITEM_IN_THIS_CATEGORY'); ?>
				</a>
			</span>
			<?php endif; ?>
		...
		<div class="itemListSubCategories">
			<h3 class="module-title"><span><?php echo JText::_('K2_CHILDREN_CATEGORIES'); ?></span></h3>
	...
	<div class="itemList">
		...
		<div id="itemListLinks" class="clearfix">
			<h4 class="itemListLinks-title"><span><?php echo JText::_('K2_MORE'); ?></span></h4>
	...
	<div class="k2Pagination">
		...
		<span class="counter"><?php if($this->params->get('catPaginationResults')) echo $this->pagination->getPagesCounter(); ?></span>
	</div>
	<?php endif; ?>
