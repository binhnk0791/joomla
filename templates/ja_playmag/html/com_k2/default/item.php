...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <!-- Related items by tag -->
	<div class="itemRelated">
		<h3 class="module-title"><span><?php echo JText::_("K2_RELATED_ITEMS_BY_TAG"); ?></span></h3>
		<ul>
  ...
  <div class="itemNavigation">
  	<h4 class="module-title"><span class="itemNavigationTitle"><?php echo JText::_('K2_MORE_IN_THIS_CATEGORY'); ?></span></h4>
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
			...
			<div class="media">
				...
				<div class="media-body">
					<span class="commentDate"><i class="fa fa-clock-o"></i> <?php echo JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT_LC')); ?></span>

				    <span class="commentAuthorName">
					    <?php if(!empty($comment->userLink)): ?>
					    <a href="<?php echo JFilterOutput::cleanText($comment->userLink); ?>" title="<?php echo JFilterOutput::cleanText($comment->userName); ?>" target="_blank" rel="nofollow">
					    	<i class="fa fa-user"></i> <?php echo $comment->userName; ?>
					    </a>
					    <?php else: ?>
				    ...
				    <p><?php echo $comment->commentText; ?></p>
						...
						<span class="commentToolbar">
							...
							<a class="modal" rel="{handler:'iframe',size:{x:560,y:480}}" href="<?php echo JRoute::_('index.php?option=com_k2&view=comments&task=report&commentID='.$comment->id)?>"><i class="fa fa-info"></i> <?php echo JText::_('K2_REPORT')?></a>
							<?php endif; ?>
