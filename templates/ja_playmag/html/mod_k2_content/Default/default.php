  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <div class="moduleItemMeta">
	      ...
	      <span class="moduleItemDateCreated"><i class="fa fa-calendar"></i> <?php echo JHTML::_('date', $item->created, JText::_('K2_DATE_FORMAT_LC')); ?></span>
	      <?php endif; ?>

	      <?php if($params->get('itemCategory')): ?>
	      <i class="fa fa-folder-open-o"></i> <a class="moduleItemCategory" href="<?php echo $item->categoryLink; ?>"><?php echo $item->categoryname; ?></a>
	      <?php endif; ?>
