...
<?php	if ($params->get('access-view')): ?>
	...
	<div class="row">
		<?php 
		$enabled = JPluginHelper::isEnabled('content', 'jabookmark');
		if($this->item->event->beforeDisplayContent):?>
		<div class="<?php echo $enabled?'col-lg-2 col-sm-2':'col-lg-12 col-sm-12';?> col-xs-12 addthis-wrap">
			<?php echo $this->item->event->beforeDisplayContent; ?>
		</div>
		<?php endif;?>
		<section class="<?php echo ($this->item->event->beforeDisplayContent && $enabled)?'col-lg-10 col-sm-10':'col-lg-12 col-sm-12';?> col-xs-12 article-content clearfix" itemprop="articleBody">
