...
<div class="blog<?php echo $this->pageclass_sfx;?>" itemscope itemtype="http://schema.org/Blog">
  ...
  <div class="page-subheader clearfix">
  		<h2 class="page-subtitle"><?php echo $this->escape($this->params->get('page_subheading')); ?></h2>
	</div>
	<?php endif; ?>
	...
	<?php if (($this->params->get('show_description_image') && $this->category->getParams()->get('image')) || $this->params->get('show_category_title') || ($this->params->get('show_description') && $this->category->description)) : ?>
