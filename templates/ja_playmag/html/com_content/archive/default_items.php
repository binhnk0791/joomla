...
<div id="archive-items">
	<?php foreach ($this->items as $i => $item) : ?>
		<article class="row row<?php echo $i % 2; ?>" itemscope itemtype="http://schema.org/Article">
			<?php echo JLayoutHelper::render('joomla.content.intro_image', $item); ?>
			<div class="item-intro col-sm-8 col-xs-12">
			<?php if ($params->get('show_category')) : ?>
				<?php echo JLayoutHelper::render('joomla.content.info_block.category', array('item' => $item, 'params' => $params)); ?>
			<?php endif; ?>
