<?php die("Access Denied"); ?>#x#s:11558:"
...
<div class="vmgroup abbba">
			...
			<div class="row productdetails">
				...
				<div class="spacer">
					...
					<a href="" class="prod-title">Dualshock PlayStation 4</a>        
	...
	<div class="addtocart-bar">
			...
			<input type="hidden" name="Itemid" value="101"/>		</form>
				...
				<div class="spacer">
					...
					<a href="/joomla/index.php/accessories/dualshock-playstation-4-detail" class="prod-title">Call of Duty</a>        
	...
	<div class="addtocart-bar">
			...
			<input type="hidden" name="Itemid" value="101"/>		</form>
				...
				<div class="spacer">
					...
					<a href="/joomla/index.php/component/virtuemart/games/games-ps4/call-of-duty-detail?Itemid=0" class="prod-title">Dualshock PlayStation 3</a>        
	...
	<div class="addtocart-bar">
			...
			<input type="hidden" name="Itemid" value="101"/>		</form>
				...
				</div><div style='clear:both;'>			<div class="col-sm-4">
				<div class="spacer">
	...
	<div class="addtocart-bar">
			...
			<input type="hidden" name="Itemid" value="101"/>		</form>
				...
				<div class="spacer">
					...
					<a href="/joomla/index.php/sony-ps/playstation-4-70-detail" title="PlayStation 4"><img src="/joomla/images/stories/virtuemart/product/resized/ps49_90x90.jpg" alt="ps49" class="featuredProductImage" border="0" /></a><div class="clear"></div>					<div class="clear"></div>
	<div class="addtocart-area">
		<form method="post" class="product js-recalculate" action="/joomla/index.php/component/virtuemart/">
			<div class="vm-customfields-wrap">
							</div>			
